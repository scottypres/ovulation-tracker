...
const ACTIONS: Action[] = [
  { type: "period_start", label: "Period started", emoji: "🩸" },
  { type: "period_end", label: "Period ended", emoji: "🌙" },
  { type: "lh_surge", label: "LH+", emoji: "⚡" },
  { type: "temp_rise", label: "Temp rise", emoji: "🌡️" },
];
